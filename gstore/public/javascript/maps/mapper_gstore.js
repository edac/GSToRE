...
var refreshcurrentLayer = function() {
	...
	//actualProtocol.options.url = "/gstore/datasets/"+ currentLayer[0].attributes.datasetid+"/features";
	...
	actualProtocol.options.url = "/apps/" + AppId + "/datasets/"+ currentLayer[0].attributes.datasetid+"/features";
...
var showmetadata = function(){
	...
	//my_items = { 'html' : '<iframe src="/apps/rgis/datasets/'+currentLayer[0].attributes.datasetid+'/metadata" width="600" height="600" frameborder=0></iframe>' };
...
Ext.onReady(function() {
	...
	rgis_base = new OpenLayers.Layer.WMS(
		...
		//"/gstore/datasets/base/services/ogc/wms?",
		//"/datasets/base/services/ogc/wms?",
		//"/apps/rgis/datasets/base/services/ogc/wms?",
		"/apps/rgis/" + AppId + "/base/services/ogc/wms?",
		{ 
...
*/
	actualProtocol = OpenLayers.Util.extend(mapfish.Protocol.MapFish, new mapfish.Protocol.MapFish({
		//url: '/gstore/datasets/'+Layers[0].id+'/features',
		//url: '/apps/rgis/datasets/'+Layers[0].id+'/features',
	...
	if(Description.what == 'bundle'){ 
		...
		//var base_wms_url = "/gstore/datasets/" + Description.id + "/services/ogc/wms_tiles?";
		//var base_wms_url = "datasets/" + Description.id + "/services/ogc/wms_tiles?";
		//var base_wms_url = "apps/rgis/datasets/" + Description.id + "/services/ogc/wms_tiles?";
