...
<!--
     This file was originally imported from 

     https://geoportal.svn.sourceforge.net/svnroot/geoportal/Geoportal/trunk/src/gpt/metadata/esri/esri-fgdc-definition.xml

     and then modified.

     9/25/2012: JBrown updates styles, and tweaks output to be W3C HTML 4.01 Strict.
     Not tested with all cases, but does work with EPHT.

     $Id: fgdc-details.xslt 1590 2012-09-25 18:05:32Z jbrown $
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    ...
    <head>
		...
		.fgdcBody dl,dt,dd {margin-left: 20px;}
