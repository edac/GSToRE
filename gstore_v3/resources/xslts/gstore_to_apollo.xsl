...
xmlns:gws="http://www.isotc211.org/2005/gws"
xmlns:dps="http://www.isotc211.org/2004/dps" xmlns:gmd="http://www.isotc211.org/2005/gmd"
xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gcv="http://www.isotc211.org/2004/gcv"
xmlns:gsr="http://www.isotc211.org/2005/gsr" xmlns:gss="http://www.isotc211.org/2005/gss"
xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:gmx="http://www.isotc211.org/2005/gmx"
xmlns:gfc="http://www.isotc211.org/2004/gfc" xmlns:xlink="http://www.w3.org/1999/xlink"
...
<!--           <xsl:if test="spatial/indspref">
           ...
           <xsl:if test="spatial/sprefs">
               <xsl:for-each select="spatial/sprefs/spref[1]">
                   <gmd:referenceSystemInfo>
                       <gmd:MD_ReferenceSystem>
                           <gmd:referenceSystemIdentifier>
                               <gmd:RS_Identifier>
                                                       ...
                                                       <gmd:CI_Contact>
                                                           <gmd:onlineResource>
                                                               <gmd:CI_OnlineResource>
                                                                   <gmd:linkage>
                                                                       <gmd:URL>http://rgis.unm.edu</gmd:URL>
                                                                   </gmd:linkage>
                                                               </gmd:CI_OnlineResource>
                                                           </gmd:onlineResource>
                                                       </gmd:CI_Contact>
                                                                        ...
                                                                        <gmd:extent>
                                                                              <gml:TimePeriod gml:id="{generate-id(.)}">
                                                                                  ...
                                                                                  <gml:beginPosition>
                                                                                      ...
                                                                                      <xsl:choose>
                                                                                          <xsl:when test="$begin-pos = 'Present'"><xsl:value-of select="/metadata/metadata/pubdate/@date"/></xsl:when>
                                                                                          <xsl:when test="$begin-pos = 'present'"><xsl:value-of select="/metadata/metadata/pubdate/@date"/></xsl:when>
                                                                                          <xsl:when test="$begin-pos = 'Now'"><xsl:value-of select="/metadata/metadata/pubdate/@date"/></xsl:when>
                                                                                          <xsl:when test="$begin-pos = 'now'"><xsl:value-of select="/metadata/metadata/pubdate/@date"/></xsl:when>
                                                                                          <xsl:when test="$begin-pos = 'unknown'">0000-01-01</xsl:when>
                                                                                          <xsl:when test="$begin-pos = 'Unknown'">0000-01-01</xsl:when>
                                                                                          <xsl:otherwise>
                                                                                  ...
                                                                                  <gml:endPosition>
                                                                                      ...
                                                                                      <xsl:choose>
                                                                                          <xsl:when test="$end-pos = 'Present'"><xsl:value-of select="/metadata/metadata/pubdate/@date"/></xsl:when>
                                                                                          <xsl:when test="$end-pos = 'present'"><xsl:value-of select="/metadata/metadata/pubdate/@date"/></xsl:when>
                                                                                          <xsl:when test="$end-pos = 'Now'"><xsl:value-of select="/metadata/metadata/pubdate/@date"/></xsl:when>
                                                                                          <xsl:when test="$end-pos = 'now'"><xsl:value-of select="/metadata/metadata/pubdate/@date"/></xsl:when>
                                                                                          <xsl:when test="$end-pos = 'unknown'">0000-01-01</xsl:when>
                                                                                          <xsl:when test="$end-pos = 'Unknown'">0000-01-01</xsl:when>
                                                                                          <xsl:otherwise>
