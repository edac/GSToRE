...
<xsl:template match="/">
  ...
  <BODY oncontextmenu="return true">
    ...
    <A name="Top"/>
    <H2><xsl:value-of select="metadata/idinfo/citation/citeinfo/title"/></H2>
    <H3>Metadata from the RGIS Metadata Repository</H3>
          ...
          <xsl:choose>
            ...
            <xsl:otherwise>
              ...
              <LI STYLE="margin-left:0.3in">
                <A>
                  <xsl:attribute name="HREF">#<xsl:value-of select="generate-id()"/></xsl:attribute>
                  Distributor <xsl:value-of select="position()"/>
                </A>
              </LI>
   ...
   <BR/><BR/><BR/><CENTER><FONT COLOR="#6495ED">Metadata stylesheets are provided courtesy of ESRI.  Copyright (c) 2000-2002, Environmental Systems Research Institute, Inc.  All rights reserved.<br/><br/>Stylesheets modified by EDAC for use in RGIS</FONT></CENTER> 
      ...
      <xsl:for-each select="descript">
        ...
        <DL>
          <xsl:for-each select="abstract">
            ...
            <DIV>
              <DT><I>Abstract:</I></DT>
              <SPAN style="font-size:small" ID="original"><xsl:value-of disable-output-escaping="yes" select="."/></SPAN>      
          ...
          <xsl:for-each select="purpose">
            <DIV>
              ...
              <SPAN style="font-size:small" ID="original"><xsl:value-of select="normalize-space(.)"/></SPAN>      
              <!--<SCRIPT>fix(original)</SCRIPT>-->      
            </DIV>
          </xsl:for-each>
          ...
          <xsl:for-each select="supplinf">
            <DIV>
              ...
              <SPAN style="font-size:small" ID="original"><xsl:value-of select="."/></SPAN>      
              <!--<SCRIPT>fix(original)</SCRIPT>-->      
            </DIV>
          ...
          <xsl:for-each select="theme">
            ...
            <DL>
              ...
              <xsl:for-each select="themekey">
                <DT><I>Theme_Keyword:</I> <xsl:value-of disable-output-escaping="yes" select="."/></DT>
              </xsl:for-each>
            </DL>
            </DD>
          </xsl:for-each>
...
<xsl:template match="citeinfo">
  ...
  <DL>
    <xsl:for-each select="origin">
      <DT><I>Originator:</I> <xsl:value-of disable-output-escaping="yes" select="."/></DT>
    </xsl:for-each>
    ...
    <xsl:for-each select="pubinfo">
      ...
      <DL>
        ...
        <xsl:for-each select="publish">
          <DT><I>Publisher:</I> <xsl:value-of disable-output-escaping="yes"  select="."/></DT>
        </xsl:for-each>
      </DL>
      </DD>
    </xsl:for-each>
...
<metaInformation>
<scenarios ><scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="AVHRRM.xml" htmlbaseurl="" outputurl="" processortype="internal" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext=""/></scenarios><MapperMetaTag><MapperInfo srcSchemaPathIsRelative="yes" srcSchemaInterpretAsXML="no" destSchemaPath="" destSchemaRoot="" destSchemaPathIsRelative="yes" destSchemaInterpretAsXML="no"/><MapperBlockPosition></MapperBlockPosition></MapperMetaTag>
</metaInformation>
-->
